...
5.1 Simmer collects and processes user data in accordance with our <a href="{{ '/privacy' | relative_url }}">Privacy Policy</a>, which is incorporated into these Terms of Use by reference.

5.2 Users grant Simmer a non-exclusive, worldwide license to use, store, and process data necessary for providing Simmer functionality.

5.3 Users are responsible for obtaining necessary consents from customers whose data may be processed through the Simmer.

## 6. Intellectual Property

### 6.1 App Intellectual Property

- All intellectual property rights in the Simmer's software, design, graphics, and underlying technology are owned by Simmer and its licensors.
...
- Using Simmer for illegal or fraudulent purposes
- Attempting to circumvent Simmer security
- Sharing account credentials
- Reverse engineering or attempting to derive source code
- Interfering with Simmer functionality
...
13.1 Any disputes shall be resolved through binding arbitration.

13.2 Arbitration shall be conducted in the jurisdiction of the Simmer's primary business location.

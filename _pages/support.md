...
### 1. Create the require Simmer collections
...
<img src="/assets/create-simmer-collections.png" alt="Create Simmer collections" style="width: 50%;">
...
<img src="/assets/add-products-to-grid.png" alt="Add products to grid" style="width: 50%;">

From the collection page, click **Browse**:

<img src="/assets/browse-modifier-products.png" alt="Browse collection" style="width: 50%;">

Then select all of your modifier products and click **Add**:

<img src="/assets/select-modifier-products.png" alt="Add modifiers to collection" style="width: 50%;">
...
<img src="/assets/add-modifier-to-collection.png" alt="Add modifier to collection" style="width: 50%;">
...
<img src="/assets/add-modifiers-block.png" alt="Select modifier from block" style="width: 50%;">
...
<img src="/assets/add-tile-step-1.png" alt="Add POS tile step 1" style="width: 50%;">

Then select **App**:

<img src="/assets/add-tile-step-2.png" alt="Add POS tile step 2" style="width: 50%;">

Then select **Simmer**:

<img src="/assets/add-tile-step-3.png" alt="Add POS tile step 3" style="width: 50%;">

Then select **Add**:

<img src="/assets/add-tile-step-4.png" alt="Add POS tile step 4" style="width: 50%;">
